...
public class SimpleAbilitySystem extends IteratingSystem{
  ...
  private World world;
    ...
    public SimpleAbilitySystem(World world, Engine engine, BodyFactory bodyFactory, KeyboardController keyCon) {
    ...
    protected void processEntity(Entity entity, float deltaTime){
      ...
      if (thistype.type == TypeComponent.PLAYER && controller.space && cooldown <= 0){
